...
robot --variable BROWSER:headlessfirefox --outputdir results --report report-firefox.html --log log-firefox.log.html --output output-firefox.xml  --noncritical bugs notedo.robot
